...
from code.models.crf2o import CRF2oDependencyModel


class EnsembleModel_CRF2o(nn.Module):
    ...
    def __init__(self, 
        ...
        self.origin = CRF2oDependencyModel(  n_words=n_words,
                                                n_feats=n_feats,
                                                n_rels=n_rels,
                                                feat=feat,
                                                n_embed=n_embed,
    ...
    def forward(self, words, feats, adds=None, pos=None):
        ...
        s_arc, s_sib, s_rel = self.origin(words, feats)
        if adds is not None:
            a_arc, a_rel = self.addition(adds)
        
            self.modifyScore(adds, a_arc, pos, s_arc)
            
            return s_arc, s_sib, s_rel, a_arc, a_rel
    ...
    def loss(self, s_arc, s_sib, s_rel, arcs, sibs, rels, mask, a_arc=None, a_rel=None, arcs_add=None,rels_add=None, mask_add=None, mbr=True, partial=False):
        r"""
        Args:
