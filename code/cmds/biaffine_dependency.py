...
from code import BiaffineDependencyParser
...
def main():
    ...
    subparser.add_argument('--train', default='code/data/ptb/train.conllx', help='path to train file')
    subparser.add_argument('--dev', default='code/data/ptb/dev.conllx', help='path to dev file')
    subparser.add_argument('--test', default='code/data/ptb/test.conllx', help='path to test file')
