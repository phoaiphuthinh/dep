...
from .parsers import (BiaffineDependencyParser, EnsembleDependencyParser, EnsembleDependencyParser_CVT)
...
PARSER = {parser.NAME: parser for parser in [BiaffineDependencyParser, EnsembleDependencyParser, EnsembleDependencyParser_CVT]}
